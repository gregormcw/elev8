...
private:
    std::atomic<bool>         shouldLoadImpulseResponse {false};
    std::atomic<const char*>  audioData                 {nullptr};
    ...
    int aziAnglesMin40[58] = {
        0, 6, 13, 19, 26, 32, 39, 45, 51, 58, 64, 71, 77, 84, 90, 96, 103,
        109, 116, 122, 129, 135, 141, 148, 154, 161, 167, 174, 180,
        -0, -6, -13, -19, -26, -32, -39, -45, -51, -58, -64, -71, -77, -84, -90, -96,
        -103, -109, -116, -122, -129, -135, -141, -148, -154, -161, -167, -174, -180};

    int aziAnglesMin20to20[74] = {
    ...
    int aziAngles80[14] = {0, 30, 60, 90, 120, 150, 180, -0, -30, -60, -90, -120, -150, -180};
